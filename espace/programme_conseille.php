...
$requete = $bdd->query("SELECT * from exercice, effectuer where exercice.id_exercice = effectuer.id_exercice and id_programme='".$id_programme."'");

while ($req = $requete->fetch())
{
  
   echo $donnees['nom']."-".$req['nom']?>&nbsp;<?php ;
